...
publication_short: ""
abstract: >
  We implement an algorithm for approximating minimal surfaces using graphical
  mean curvature flow, leveraging the monotonically non-increasing area under
  such a flow. Our approach demonstrates well-established results in minimal
  surface theory, including the inheritance of planarity and rotational symmetry
  from their Dirichlet boundary data. Furthermore, we highlight the flow's
